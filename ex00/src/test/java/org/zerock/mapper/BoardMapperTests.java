...
public class BoardMapperTests {
  ...
  /*
   * @Test public void tesetInsertSelectKey() { BoardVO board = new BoardVO();
   ...
   * 
   * board.setBno(5L); board.setTitle("수정된제목"); board.setContent("수정된내용");
   ...
   * cri.setPageNum(2); cri.setAmount(10);
   * 
